...
<main>
	<section class="service-hero" style="background:linear-gradient(135deg,rgba(14,26,36,.97),rgba(20,37,51,.92)),url('../images/index-image-7.jpg') center/cover;">
		<div class="container">
...
<script type="application/ld+json">
{
  ...
  "image": "../images/index-image-7.jpg",
  "author": {
    "@type": "Organization",
