...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/receipt.gif" alt="Tax preparation icon"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/receipt.gif" alt="Tax preparation icon"> Accounting and Bookkeeping</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>VAT / GST tracking</h3><p>Tax collected and paid tracked accurately on every relevant transaction.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Tax filing support data</h3><p>Organized, categorized records assembled and ready for filing.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Deadline tracking</h3><p>Key filing dates tracked so nothing is submitted late.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Deduction-ready records</h3><p>Expenses categorized so legitimate deductions are easy to identify.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> VAT / GST tracking on every applicable transaction</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Organized tax filing support data by category and period</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Deduction and expense categorization review</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Filing deadline tracking and reminders</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Coordination with your accountant or tax preparer</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Prior-period record cleanup if needed</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
