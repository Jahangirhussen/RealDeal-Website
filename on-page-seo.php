...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-badge"><i class="fa-solid fa-file-lines"></i> Search Engine Optimization (SEO)</div>
			<h1>On-Page SEO</h1>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Sharper keyword targeting</h3><p>Every page mapped to primary and long-tail keywords with real search intent.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Higher-converting content</h3><p>Copy written to satisfy both readers and search engines.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Cleaner page structure</h3><p>URLs, internal links and images built for crawlability.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Stronger click-through rates</h3><p>Optimized titles and meta descriptions that earn the click in search results.</p></article></div>
				</div>
				<aside class="sidebar">
...
<a class="related-link" href="technical-seo.php"><i class="fa-solid fa-gauge-high"></i> Technical SEO</a>
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Primary keyword analysis and search intent mapping</li><li><i class="fa-solid fa-circle-check"></i> Long-tail keyword research for supporting content</li><li><i class="fa-solid fa-circle-check"></i> SEO content writing for priority pages</li><li><i class="fa-solid fa-circle-check"></i> Meta title and description optimization</li><li><i class="fa-solid fa-circle-check"></i> URL structure optimization</li><li><i class="fa-solid fa-circle-check"></i> Internal linking strategy and implementation</li><li><i class="fa-solid fa-circle-check"></i> Image SEO and alt tag optimization</li><li><i class="fa-solid fa-circle-check"></i> SEO performance audit</li><li><i class="fa-solid fa-circle-check"></i> Competitor analysis</li><li><i class="fa-solid fa-circle-check"></i> Header tag (H1–H3) optimization</li><li><i class="fa-solid fa-circle-check"></i> Monthly on-page performance reporting</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
