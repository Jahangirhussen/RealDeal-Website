...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/document.gif" alt="On-page SEO icon"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/document.gif" alt="On-page SEO icon"> Search Engine Optimization (SEO)</div>
			<h1>On-Page SEO</h1>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Sharper keyword targeting</h3><p>Every page mapped to primary and long-tail keywords with real search intent.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Higher-converting content</h3><p>Copy written to satisfy both readers and search engines.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Cleaner page structure</h3><p>URLs, internal links and images built for crawlability.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Stronger click-through rates</h3><p>Optimized titles and meta descriptions that earn the click in search results.</p></article></div>
				</div>
				<aside class="sidebar">
...
<a class="related-link" href="technical-seo.php"><i class="fa-solid fa-gauge-high"></i> Technical SEO</a>
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Primary keyword analysis and search intent mapping</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Long-tail keyword research for supporting content</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> SEO content writing for priority pages</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Meta title and description optimization</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> URL structure optimization</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Internal linking strategy and implementation</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Image SEO and alt tag optimization</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> SEO performance audit</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Competitor analysis</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Header tag (H1–H3) optimization</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Monthly on-page performance reporting</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
