...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/brands/facebook.svg" alt="Facebook logo"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/brands/facebook.svg" alt="Facebook logo"> Digital Marketing</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Optimized business Page</h3><p>A fully set up Page with complete profile, contact and category details that build trust instantly.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>On-brand content</h3><p>Posts designed and written to match your brand voice and stop the scroll in the feed.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Precise ad targeting</h3><p>Campaigns aimed at the audiences most likely to convert, not just broad reach.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Warm audience retargeting</h3><p>Retargeting ads that bring back visitors and engaged users who didn't convert the first time.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Business Page creation and setup</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Profile optimization (about, categories, CTAs)</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Post design and copywriting</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Content calendar management</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Facebook Ads campaign setup</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Audience targeting and segmentation</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Retargeting ad campaigns</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Monthly performance reporting</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
