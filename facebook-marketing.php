...
<main>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Optimized business Page</h3><p>A fully set up Page with complete profile, contact and category details that build trust instantly.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>On-brand content</h3><p>Posts designed and written to match your brand voice and stop the scroll in the feed.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Precise ad targeting</h3><p>Campaigns aimed at the audiences most likely to convert, not just broad reach.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Warm audience retargeting</h3><p>Retargeting ads that bring back visitors and engaged users who didn't convert the first time.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Business Page creation and setup</li><li><i class="fa-solid fa-circle-check"></i> Profile optimization (about, categories, CTAs)</li><li><i class="fa-solid fa-circle-check"></i> Post design and copywriting</li><li><i class="fa-solid fa-circle-check"></i> Content calendar management</li><li><i class="fa-solid fa-circle-check"></i> Facebook Ads campaign setup</li><li><i class="fa-solid fa-circle-check"></i> Audience targeting and segmentation</li><li><i class="fa-solid fa-circle-check"></i> Retargeting ad campaigns</li><li><i class="fa-solid fa-circle-check"></i> Monthly performance reporting</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
