...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-badge"><i class="fa-solid fa-file-invoice-dollar"></i> Accounting and Bookkeeping</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Invoice creation</h3><p>Accurate, branded invoices issued promptly for every sale or engagement.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Payment tracking</h3><p>Every payment logged and matched against the invoice it settles.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Faster collections</h3><p>Structured follow-up on outstanding invoices so you get paid sooner.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Cash flow visibility</h3><p>A clear, current picture of exactly what customers still owe.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Invoice creation and delivery for every sale</li><li><i class="fa-solid fa-circle-check"></i> Payment tracking and matching against open invoices</li><li><i class="fa-solid fa-circle-check"></i> Customer record and terms maintenance</li><li><i class="fa-solid fa-circle-check"></i> Receivables aging report management</li><li><i class="fa-solid fa-circle-check"></i> Structured follow-up on overdue balances</li><li><i class="fa-solid fa-circle-check"></i> Monthly accounts receivable summary</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
