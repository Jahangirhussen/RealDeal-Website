...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/invoice-dollar.gif" alt="Accounts receivable icon"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/invoice-dollar.gif" alt="Accounts receivable icon"> Accounting and Bookkeeping</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Invoice creation</h3><p>Accurate, branded invoices issued promptly for every sale or engagement.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Payment tracking</h3><p>Every payment logged and matched against the invoice it settles.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Faster collections</h3><p>Structured follow-up on outstanding invoices so you get paid sooner.</p></article><article class="benefit-card"><div class="benefit-icon"><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"></div><h3>Cash flow visibility</h3><p>A clear, current picture of exactly what customers still owe.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Invoice creation and delivery for every sale</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Payment tracking and matching against open invoices</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Customer record and terms maintenance</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Receivables aging report management</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Structured follow-up on overdue balances</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Monthly accounts receivable summary</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
