...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/cart.gif" alt="Ecommerce website development icon"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/cart.gif" alt="Ecommerce website development icon"> Web Design &amp; Development</div>
