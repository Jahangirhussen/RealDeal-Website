...
<title>Miranda's English Club Case Study | RealDeal IT Center</title>
<meta name="description" content="How we grew social media presence and engagement for Miranda's English Club, a language school in Tbilisi, Georgia.">
<link rel="canonical" href="https://jahangirhussen.github.io/RealDeal_Home/portfolio/mirandas-english-club-social-media-growth/">
<meta property="og:type" content="article">
<meta property="og:title" content="Miranda's English Club Case Study | RealDeal IT Center">
<meta property="og:description" content="How we grew social media presence and engagement for Miranda's English Club, a language school in Tbilisi, Georgia.">
<meta property="og:url" content="https://jahangirhussen.github.io/RealDeal_Home/portfolio/mirandas-english-club-social-media-growth/">
...
.service-hero { padding:150px 0 70px; background:linear-gradient(135deg,rgba(14,26,36,.96),rgba(20,37,51,.94)),url("https://realdealitcenter.com/wp-content/uploads/2026/07/mirandas-english-club-social-media-growth-cover.webp") center/cover; color:#fff; }
	...
	<section class="service-hero">
		<div class="container">
			<nav class="breadcrumb" aria-label="Breadcrumb">
				...
				<span>Miranda's English Club</span>
			</nav>
			<div class="hero-badge"><i class="fa-solid fa-star"></i> Case Study</div>
			<h1>Miranda's English Club — Social Media Growth</h1>
			<p class="lead">Helping a Tbilisi-based language school build a consistent, engaging social media presence to attract new students.</p>
			<div class="hero-actions">
				...
				<a class="btn btn-outline" href="https://www.facebook.com/mirandasenglishclub" target="_blank" rel="noopener" style="background:rgba(255,255,255,.1);color:#fff;border-color:rgba(255,255,255,.25);"><i class="fa-brands fa-facebook-f"></i> Facebook Page</a>
			</div>
			<div class="hero-meta">
				<div>Client<strong>Miranda's English Club</strong></div>
				<div>Industry<strong>Education / Language School</strong></div>
				<div>Location<strong>Tbilisi, Georgia</strong></div>
			...
			<div class="detail-grid">
				<div class="article-body">
					...
					<div>
						...
						<p class="section-copy">Miranda's English Club runs in-person language classes in Tbilisi, Georgia, but its social media presence was inconsistent — irregular posting, low engagement and no clear content plan to reach prospective students where they already spend their time.</p>
						<div class="cs-stats-strip">
							...
							<div class="cs-stat"><i class="fa-solid fa-arrows-rotate" style="color:var(--rd-blue);"></i><strong>2023</strong><span>Engagement</span></div>
							<div class="cs-stat"><i class="fa-solid fa-location-dot" style="color:var(--rd-teal);"></i><strong>Tbilisi, Georgia</strong><span>Based</span></div>
							<div class="cs-stat"><i class="fa-solid fa-graduation-cap" style="color:var(--rd-green);"></i><strong>Language School</strong><span>Business Type</span></div>
						</div>
					</div>
					...
					<div>
						...
						<div class="cs-check-grid">
							...
							<div class="cs-check-card"><i class="fa-solid fa-circle-check"></i><p>Stronger engagement with the local Tbilisi community</p></div>
							<div class="cs-check-card"><i class="fa-solid fa-circle-check"></i><p>A clear, recognisable brand voice across channels</p></div>
							<div class="cs-check-card"><i class="fa-solid fa-circle-check"></i><p>Content that turns followers into enquiries and enrollments</p></div>
						</div>
					</div>
					...
					<div>
						...
						<div class="cs-challenge-grid">
							...
							<div class="cs-challenge-card"><i class="fa-solid fa-triangle-exclamation"></i><p>Low engagement gave little visibility with prospective students</p></div>
							<div class="cs-challenge-card"><i class="fa-solid fa-triangle-exclamation"></i><p>No repeatable system the school could keep running on its own</p></div>
						</div>
					</div>
					...
					<div>
						...
						<p class="section-copy">Miranda's English Club needed one thing done well: a social media presence that actually brings in students. Here's exactly what the service covered and the benefit it delivered.</p>
						<div class="cs-service-list">
							<div class="cs-service-item" style="--item-accent:var(--rd-blue);">
								...
								<div>
									...
									<p class="cs-service-desc">We built a structured social media plan around Facebook and Instagram, covering a consistent content calendar, class-highlight and student-testimonial style posts, and community engagement to turn followers into enquiries and enrollments.</p>
									<div class="cs-service-benefit"><i class="fa-solid fa-arrow-trend-up"></i><div><strong>Benefit to the client</strong><p>A consistent, engaging presence that keeps the school top of mind for prospective students in Tbilisi.</p></div></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div>
						...
						<div class="pdf-viewer-layout">
							<div class="pdf-tabs" id="pdf-tabs">
								<button type="button" class="pdf-tab active" data-pdf="../assets/pdf/mirandas-english-club/mirandas-facebook.pdf"><i class="fa-brands fa-facebook-f"></i> Facebook</button>
							</div>
					...
					<div>
						...
						<div class="cs-results-grid">
							...
							<div class="cs-result-card"><i class="fa-solid fa-users"></i><strong>Stronger local engagement</strong></div>
					...
					<div>
						...
						<div class="cs-testimonial">
							...
							<span>Role, Miranda's English Club</span>
						</div>
					</div>
					<?php endif; ?>
					...
					<div>
						...
						<div class="cs-related-grid">
							...
							<a class="cs-related-card" href="trb-fashion-social-media-growth.php">
								<img src="https://realdealitcenter.com/wp-content/uploads/2026/07/trb-fashion-social-media-growth-cover.webp" alt="TRB Fashion">
								<div class="cs-related-card-body"><span>Digital Marketing</span><h4>TRB Fashion</h4></div>
							</a>
						</div>
					</div>
				...
				<aside class="sidebar">
					<div class="sidebar-card">
						...
						<table class="cs-info-table">
							<tr><td>Client</td><td>Miranda's English Club</td></tr>
							<tr><td>Industry</td><td>Education / Language School</td></tr>
							<tr><td>Country</td><td>Georgia</td></tr>
							<tr><td>Duration</td><td>2023</td></tr>
							<tr><td>Started</td><td>2023</td></tr>
							<tr><td>Facebook</td><td><a href="https://www.facebook.com/mirandasenglishclub" target="_blank" rel="noopener" style="color:var(--rd-orange);">Miranda's English Club</a></td></tr>
...
<script type="application/ld+json">
{
  ...
  "@type": "CreativeWork",
  "name": "Miranda's English Club — Social Media Growth",
  "description": "How we grew social media presence and engagement for Miranda's English Club, a language school in Tbilisi, Georgia.",
  "image": "https://realdealitcenter.com/wp-content/uploads/2026/07/mirandas-english-club-social-media-growth-cover.webp",
  "url": "https://jahangirhussen.github.io/RealDeal_Home/portfolio/mirandas-english-club-social-media-growth/",
  "about": "Miranda's English Club"
}
</script>
