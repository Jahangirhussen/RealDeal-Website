...
.service-hero { padding:138px 0 64px; background:linear-gradient(135deg,rgba(14,26,36,.97),rgba(20,37,51,.92)),url("../images/mirandas-english-club-social-media-growth-cover.jpg") center/cover; color:#fff; }
	...
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-meta">
				...
				<div>Budget Tier<strong>££</strong></div>
				<div>Year<strong>2023</strong></div>
			</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div class="article-body">
					...
					<p>Miranda's English Club runs in-person language classes in Tbilisi, Georgia, but its social media presence was inconsistent — irregular posting, low engagement and no clear content plan to reach prospective students where they already spend their time.</p>
					<h3>Our Approach</h3>
					<p>We built a structured social media plan around Facebook and Instagram, covering a consistent content calendar, class-highlight and student-testimonial style posts, and community engagement to turn followers into enquiries and enrollments.</p>
					<h3>The Results</h3>
					<ul class="result-list">
						<li><i class="fa-solid fa-circle-check"></i> Consistent posting schedule replacing ad-hoc updates</li>
						<li><i class="fa-solid fa-circle-check"></i> Stronger engagement on Facebook with the local Tbilisi community</li>
						<li><i class="fa-solid fa-circle-check"></i> A repeatable content system the school can keep running</li>
						<li><i class="fa-solid fa-circle-check"></i> Clearer brand presence supporting new student enquiries</li>
					</ul>
				</div>
				<aside class="sidebar">
					<div class="sidebar-card">
						<h3>Project snapshot</h3>
						<div class="sidebar-stat"><span>Client</span><strong>Miranda's English Club</strong></div>
						<div class="sidebar-stat"><span>Industry</span><strong>Education</strong></div>
						<div class="sidebar-stat"><span>Category</span><strong>Digital Marketing</strong></div>
						<div class="sidebar-stat"><span>Location</span><strong>Tbilisi, Georgia</strong></div>
						<div class="sidebar-stat" style="border:0;"><span>Year</span><strong>2023</strong></div>
					...
					<div class="sidebar-card">
						...
						<a class="related-link" href="https://www.facebook.com/mirandasenglishclub" target="_blank" rel="noopener"><i class="fa-brands fa-facebook-f"></i> Facebook Page</a>
					</div>
				</aside>
			</div>
		</div>
