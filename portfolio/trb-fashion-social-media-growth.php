...
.service-hero { padding:138px 0 64px; background:linear-gradient(135deg,rgba(14,26,36,.97),rgba(20,37,51,.92)),url("../images/trb-fashion-social-media-growth-cover.jpg") center/cover; color:#fff; }
	...
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-meta">
				...
				<div>Year<strong>2021</strong></div>
			</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div class="article-body">
					...
					<p>TRB Fashion had strong collections but an inconsistent social media presence — irregular posting and no structured way to showcase new arrivals or reach shoppers actively browsing for fashion inspiration.</p>
					<h3>Our Approach</h3>
					<p>We built a structured social media plan around Facebook and Instagram, covering a consistent content calendar, collection-focused visual content, and community engagement to turn followers into shoppers.</p>
					<h3>The Results</h3>
					<ul class="result-list">
						<li><i class="fa-solid fa-circle-check"></i> Consistent posting schedule replacing ad-hoc updates</li>
						<li><i class="fa-solid fa-circle-check"></i> Stronger collection visibility across social channels</li>
				...
				<aside class="sidebar">
					<div class="sidebar-card">
						...
						<div class="sidebar-stat"><span>Client</span><strong>TRB Fashion</strong></div>
						<div class="sidebar-stat"><span>Industry</span><strong>Fashion / Retail</strong></div>
						...
						<div class="sidebar-stat" style="border:0;"><span>Year</span><strong>2021</strong></div>
					...
					<div class="sidebar-card">
						...
						<a class="related-link" href="https://www.facebook.com/trbfashion" target="_blank" rel="noopener"><i class="fa-brands fa-facebook-f"></i> Facebook Page</a>
					</div>
				</aside>
			</div>
		</div>
