...
.service-hero { padding:150px 0 70px; background:linear-gradient(135deg,rgba(14,26,36,.96),rgba(20,37,51,.94)),url("../images/index-image-18.jpg") center/cover; color:#fff; }
				...
				<div class="article-body">
					...
					<div>
						...
						<div class="cs-gallery">
							<img src="../images/index-image-18.jpg" alt="Restaurant interior" loading="lazy">
							<img src="../images/bros-slice-grill-restaurant-digital-transformation-grill-dish.jpg" alt="Grill dish" loading="lazy">
...
<script type="application/ld+json">
{
  ...
  "image": "../images/index-image-18.jpg",
