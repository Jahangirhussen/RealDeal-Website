...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-badge"><i class="fa-solid fa-chart-pie"></i> Accounting and Bookkeeping</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Profit &amp; loss statement</h3><p>A clear month-by-month view of revenue, costs and margin.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Balance sheet preparation</h3><p>Assets, liabilities and equity presented accurately at a glance.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Cash flow reporting</h3><p>Monthly visibility into what's coming in and going out.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Expense summary reporting</h3><p>Spending broken down by category so trends are easy to spot.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Profit &amp; loss statement preparation</li><li><i class="fa-solid fa-circle-check"></i> Balance sheet preparation</li><li><i class="fa-solid fa-circle-check"></i> Monthly cash flow report</li><li><i class="fa-solid fa-circle-check"></i> Monthly expense summary report</li><li><i class="fa-solid fa-circle-check"></i> Budget vs. actual reporting</li><li><i class="fa-solid fa-circle-check"></i> Year-over-year trend analysis</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
