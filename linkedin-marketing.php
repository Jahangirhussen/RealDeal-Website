...
<main>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Credible profile</h3><p>A professional profile and company page positioned to earn trust from buyers.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Targeted lead generation</h3><p>Outreach and content strategy focused on reaching decision-makers directly.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Authority content</h3><p>Articles and posts that position your brand as a trusted voice in your industry.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Pipeline impact</h3><p>Activity focused on generating qualified conversations, not just impressions.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Professional profile setup</li><li><i class="fa-solid fa-circle-check"></i> Company page optimization</li><li><i class="fa-solid fa-circle-check"></i> Lead generation strategy</li><li><i class="fa-solid fa-circle-check"></i> Decision-maker targeting and outreach</li><li><i class="fa-solid fa-circle-check"></i> Article and post creation</li><li><i class="fa-solid fa-circle-check"></i> Content calendar management</li><li><i class="fa-solid fa-circle-check"></i> Monthly pipeline and engagement report</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
