...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="service-hero-icon"><img class="fa-icon-img" src="assets/icons-animated/money-transfer.gif" alt="Accounts payable icon"></div>
			<div class="hero-badge"><img class="fa-icon-img" src="assets/icons-animated/money-transfer.gif" alt="Accounts payable icon"> Accounting and Bookkeeping</div>
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Vendor bill recording and coding to the right account</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Payment scheduling against due dates and terms</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Vendor master file setup and maintenance</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Payables aging report management</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Payment terms and dispute support</li><li><img class="fa-icon-img" src="assets/icons-animated/check.gif" alt="Check"> Monthly accounts payable summary</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
