...
<main>
	<section class="service-hero">
		<div class="container">
			...
			<div class="hero-badge"><i class="fa-solid fa-money-bill-transfer"></i> Accounting and Bookkeeping</div>
		...
		<div class="container">
			<div class="detail-grid">
				<div>
					...
					<div class="benefit-grid"><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Bill recording</h3><p>Every vendor bill logged and matched to the right account as it comes in.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Payment scheduling</h3><p>Due dates tracked and payments queued so nothing is ever late.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Vendor relationships protected</h3><p>Consistent, on-time payments that keep suppliers happy and terms favorable.</p></article><article class="benefit-card"><div class="benefit-icon"><i class="fa-solid fa-check"></i></div><h3>Cash flow visibility</h3><p>A clear, current picture of exactly what you owe and when.</p></article></div>
				</div>
				<aside class="sidebar">
	...
	<section class="detail-section alt">
		<div class="container">
			...
			<ul class="include-list"><li><i class="fa-solid fa-circle-check"></i> Vendor bill recording and coding to the right account</li><li><i class="fa-solid fa-circle-check"></i> Payment scheduling against due dates and terms</li><li><i class="fa-solid fa-circle-check"></i> Vendor master file setup and maintenance</li><li><i class="fa-solid fa-circle-check"></i> Payables aging report management</li><li><i class="fa-solid fa-circle-check"></i> Payment terms and dispute support</li><li><i class="fa-solid fa-circle-check"></i> Monthly accounts payable summary</li></ul>
		</div>
	</section>
	<section class="detail-section">
		<div class="container">
